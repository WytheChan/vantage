const message = {
  ...
  about: { //关于
    gk: '公司概况',
    gk_text:`  
      广州寰逸企业管理咨询有限公司致力于给国内外企业和候选人提供综合性人才服务，与行业内多家标杆客户保持良好的合作关系，服务领域包括高科技、IT/互联网、市场传媒、制造业、零售业、金融财会等。<br/><br/>
      我司是企业的人才战略合作伙伴和候选人的职业生涯规划师。通过提供高附加值服务，与企业和候选人共成长。既深入、清晰了解企业需求，为企业输送所期待的合适人选，又分析解剖候选人的优势和特性，发掘其潜力，为双方提供最佳人才解决方案。<br/><br/>
      我们立足广州，业务遍及中国大陆、港澳台和海外，拥有丰富的客户资源和成功案例。我们以快乐工作、耐心沟通为指引，让来自熟悉相关行业的资深顾问在活跃的氛围中施展拳脚，获得更多。
    `,
    dw: '企业定位',
    dw_text:'寰逸猎头，是企业的人才战略合作伙伴和候选人的职业生涯规划师。',
    case: '成功案例',
    case_list:{  //案例的类目
      position:'入职职位',
      company:'企业信息',
  ...
  plan: { //精英计划
    plan: {
      ...
      stitle: ' 学生培训',
      stitle2: ' 社会人士培训',
      content: ' 进入校园，针对广大学生选专业、择业方向和相关技能进行培训，在人生关键时点助力学生更清楚认识自己、认识社会，成为目标明确、发展路径清晰的人，提早准备成为真正的社会人。',
      content2: ' 帮助对前途迷茫、不知所措的社会人士提高自我认知能力和技能，取长补短以能轻装上阵，适得其所。',
      youshi_title:'专业优势',
